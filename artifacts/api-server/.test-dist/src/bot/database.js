...
export class GameDatabase {
    ...
    async collection(discordId, page = 1, pageSize = 8) {
       ...
       WHERE discord_id = $1`, [discordId]);
        ...
        const result = await this.pool.query(`SELECT c.id AS "characterId", c.name, c.series, c.rarity, c.value, o.quantity, o.favorite
    ...
    async profile(discordId) {
        const result = await this.pool.query(`SELECT u.currency, u.rolls_used, u.claims_count,
